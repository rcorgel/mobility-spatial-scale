################################################################################
# File Name: 05k_figure_S.6_nested_sen                                         #
#                                                                              #
...
adm_3_phone_mobility_mat_rescale_adm_2_long <- left_join(adm_3_phone_mobility_mat_rescale_adm_2_long, admin_xwalk[, c(1, 2)], 
...
adm_3_phone_mobility_mat_rescale_adm_1_long <- left_join(adm_3_phone_mobility_mat_rescale_adm_1_long, admin_xwalk[, c(1, 3)], 
                                       by = c('destination' = 'adm_3'))
# Merge on origin
adm_3_phone_mobility_mat_rescale_adm_1_long <- left_join(adm_3_phone_mobility_mat_rescale_adm_1_long, admin_xwalk[, c(1, 3)],
                                       by = c('origin' = 'adm_3'))
...
adm_3_adm_1_phone <- adm_3_phone_mobility_mat_rescale_adm_1_long |>
...
# Merge on destination
adm_2_phone_mobility_mat_rescale_long <- left_join(adm_2_phone_mobility_mat_rescale_long, admin_xwalk_adm_2, 
...
adm_2_adm_1_phone <- adm_2_phone_mobility_mat_rescale_long |>
  filter(adm_1.x != adm_1.y) |>
  group_by(origin) |>
  mutate(adm_2_sum = sum(value_rescale, na.rm = TRUE)) |>
...
ggsave('./figs/figure_S.6_nested_sen.jpg', plot = figure_3, height = 25, width = 18)
