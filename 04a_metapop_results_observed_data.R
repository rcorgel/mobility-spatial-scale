...
# Save
saveRDS(adm_3_obs_col, file = './out/adm_3_obs_col_1.5.rds')
...
# Save
saveRDS(adm_3_obs_del, file = './out/adm_3_obs_del_1.5.rds')
...
# Save
saveRDS(adm_2_obs_col, file = './out/adm_2_obs_col_1.5.rds')
...
# Save
saveRDS(adm_2_obs_del, file = './out/adm_2_obs_del_1.5.rds')
...
# Save
saveRDS(adm_1_obs_col, file = './out/adm_1_obs_col_1.5.rds')
...
# Save
saveRDS(adm_1_obs_del, file = './out/adm_1_obs_del_1.5.rds')
...
# Save
saveRDS(adm_3_obs_col, file = './out/adm_3_obs_col_1.1.rds')
remove(adm_3_obs_col)
...
# Save
saveRDS(adm_3_obs_del, file = './out/adm_3_obs_del_1.1.rds')
remove(adm_3_obs_del)
...
# Save
saveRDS(adm_2_obs_col, file = './out/adm_2_obs_col_1.1.rds')
remove(adm_2_obs_col)
...
# Save
saveRDS(adm_2_obs_del, file = './out/adm_2_obs_del_1.1.rds')
remove(adm_2_obs_del)
...
# Save
saveRDS(adm_1_obs_col, file = './out/adm_1_obs_col_1.1.rds')
remove(adm_1_obs_col)
...
# Save
saveRDS(adm_1_obs_del, file = './out/adm_1_obs_del_1.1.rds')
remove(adm_1_obs_del)
...
# Save
saveRDS(adm_3_obs_col, file = './out/adm_3_obs_col_3.0.rds')
remove(adm_3_obs_col)
...
# Save
saveRDS(adm_3_obs_del, file = './out/adm_3_obs_del_3.0.rds')
remove(adm_3_obs_del)
...
# Save
saveRDS(adm_2_obs_col, file = './out/adm_2_obs_col_3.0.rds')
remove(adm_2_obs_col)
...
# Save
saveRDS(adm_2_obs_del, file = './out/adm_2_obs_del_3.0.rds')
remove(adm_2_obs_del)
...
# Save
saveRDS(adm_1_obs_col, file = './out/adm_1_obs_col_3.0.rds')
remove(adm_1_obs_col)
