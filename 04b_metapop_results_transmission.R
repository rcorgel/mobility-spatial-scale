################################################################################
# File Name: 04b_metapop_results_transmission                                  #
#                                                                              #
...
run_seir_model_multi_adm_3 <- function(r_naught, intro_loc, data) {
  
  # Run model
  adm_3 <- run_seir_model_multi(n = 100, density_dep = FALSE, method = 'append',
                                R_0 = r_naught, gamma = 1/7, sigma = 1/2, prop_s = 0.90, 
...
# Colombo
adm_3_mp <- mclapply(seq(1, 4, 0.1), run_seir_model_multi_adm_3, intro_loc = 'Colombo', data = adm_3_phone_mobility_mat)
...
# Madhu
adm_3_mp <- mclapply(seq(1, 4, 0.1), run_seir_model_multi_adm_3, intro_loc = 'Madhu', data = adm_3_phone_mobility_mat)
...
# Colombo
adm_3_sim <- mclapply(seq(1, 4, 0.1), run_seir_model_multi_adm_3, intro_loc = 'Colombo', data = adm_3_phone_pred_mobility_mat)
...
# Madhu
adm_3_sim <- mclapply(seq(1, 4, 0.1), run_seir_model_multi_adm_3, intro_loc = 'Madhu', data = adm_3_phone_pred_mobility_mat)
...
save(list = c('adm_1_at_1_mp_col',
              ...
              'adm_3_at_2_sim_mad', 
              'adm_2_at_2_sim_mad'), 
     file = './tmp/transmissibility_model_results.RData')
